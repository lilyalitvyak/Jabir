...
-(void) setPushEnableWithNode:(NSString *)node andSecret:(NSString *)secret
{
    ...
    //this push jid is hardcoded and does not have to be the same hostname as the api endpoint set in JabirAppDelegate.m
    [enableNode.attributes setObject:@"push.jabir.im" forKey:@"jid"];
...
-(void) setDiscoInfoWithFeaturesAndNode:(NSString*) node
{
    ...
    [identityNode.attributes setObject:@"client" forKey:@"category"];
     ...
     [identityNode.attributes setObject:[NSString stringWithFormat:@"Jabir %@", [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"]] forKey:@"name"];
...
-(void) setJingleInitiateTo:(NSString*) jid andResource:(NSString*) resource withValues:(NSDictionary*) info
{
   ...
   MLXMLNode* contentNode =[[MLXMLNode alloc] init];
    ...
    [candidate1.attributes setObject:@"jabir001" forKey:@"id"];
    ...
    [candidate2.attributes setObject:@"jabir002" forKey:@"id"];
...
//         <candidate component=\"1\" ip=\"%@\" port=\"%@\"   id=\"jabir001\" generation=\"0\"   />
//         <candidate component=\"2\" ip=\"%@\" port=\"%@\"   id=\"jabir002\" generation=\"0\"  /> </transport> </content>
//         
