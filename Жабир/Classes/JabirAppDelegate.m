...
@implementation JabirAppDelegate


-(void) setUISettings
{
    UIColor *jabirGreen = [UIColor colorNamed:@"jr-color-green"];
    UIColor *jabirdarkGreen = [UIColor colorNamed:@"jr-color-dark-green"];
    
    [[UINavigationBar appearance] setBarTintColor:jabirGreen];
    ...
    if (@available(iOS 11.0, *)) {
        ...
        [[UINavigationBar appearance] setLargeTitleTextAttributes:@{
                                                                    NSForegroundColorAttributeName: [UIColor whiteColor],
                                                                    NSFontAttributeName: [UIFont fontWithName:@"SFUIDisplay-Heavy" size:28.0]
                                                                    }];
    }
    
    [[UITabBar appearance] setTintColor:jabirdarkGreen];
...
-(void)pushRegistry:(PKPushRegistry *)registry didUpdatePushCredentials: (PKPushCredentials *)credentials forType:(NSString *)type
{
    ...
    [request setURL:[NSURL URLWithString:@"https://push.jabir.im:5281/push_appserver/v1/register"]];
...
//    [DBSession setSharedSession:dbSession];
    [DBClientsManager setupWithAppKey:@"a134q2ecj1hqa59"];
