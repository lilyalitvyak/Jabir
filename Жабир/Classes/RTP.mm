...
[[AVAudioSession sharedInstance] setCategory: AVAudioSessionCategoryPlayAndRecord error: nil];
    ...
    NSString* jabirNetReadQueue =@"im.jabir.jingleReadQueue.%@";
    NSString* jabirNetWriteQueue =@"im.jabir.jingleWriteQueue.%@";
    
    dispatch_queue_t _netReadQueue = dispatch_queue_create([jabirNetReadQueue UTF8String], DISPATCH_QUEUE_SERIAL);
    dispatch_queue_t _netWriteQueue = dispatch_queue_create([jabirNetWriteQueue UTF8String], DISPATCH_QUEUE_SERIAL);
